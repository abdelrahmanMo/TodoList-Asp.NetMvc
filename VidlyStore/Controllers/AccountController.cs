...
namespace VidlyStore.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            ViewBag.Roles = new SelectList(_context.Roles.Where(m => !m.Name.Contains("Admin")).ToList(), "Name", "Name");
            return View();
        }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    //code i made to make every one manger
                    //create role
                ...
                ViewBag.Roles = new SelectList(_context.Roles.Where(m => !m.Name.Contains("Admins")).ToList(), "Name", "Name");
                AddErrors(result);
            }
